...
import track8 from './audio/for_albums/Golubka.mp3'
import track9 from './audio/for_albums/Dyvo_zaraz.mp3'
export const  albums = [
...
export const tracks = [
    ...
    { id: 4 , src : track4, title : 'Экстатична радість ', description : 'авторский джаз' },
